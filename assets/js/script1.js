...
var wodBtnEl = document.getElementById("wodBtn");
var today = moment();
today.hours(0);
today.minutes(0);
...
function randomWord() {
    ...
    console.log("In random word.  wodModalText = " + wodModalText);
        ...
        fetch("https://wordsapiv1.p.rapidapi.com/words/?random=true", {
            ...
            var wodModalText = response.word 
...
function displayRandomWord() {
            console.log("Entering displayRandomWord")
           ...
           //var word = wodModalText;  //changed
            ...
            bodyEl.textContent = wodModalText;
            console.log(wodModalText);
...
function recallRandomWord() {
    ...
    if (randomWordData.length === 0 || today.diff(moment(randomWordData[0], "L"))) {
        ...
        console.log(randomWordData[0], "L")
...
wodBtnEl.addEventListener("click", function(event) {
   event.preventDefault();
   displayRandomWord();
});
